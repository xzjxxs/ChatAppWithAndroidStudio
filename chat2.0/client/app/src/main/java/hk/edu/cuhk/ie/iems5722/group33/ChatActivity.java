...
public class ChatActivity extends AppCompatActivity {
    ...
    private String senderId = LoginActivity.uid;
    private String senderName = LoginActivity.un;
...
//                Msg msg = new Msg(1155161089, "Xu", sendMsg, timeMsg, 1);
                ...
                sendTask.execute(sendUrl, chatroomId, senderId, senderName, sendMsg);
        ...
        try {
            socket = IO.socket("http://18.116.63.13:8001/");
            ...
            try {
                ...
                if (status.equals("OK")) {
                    for (int i = 0; i < messagesArray.length(); i++) {
                        ...
                        if (Integer.toString(user_id).equals(senderId)) {
    ...
    private class sendMsgTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String sendResult) {
            msgList.clear();
            inputText.setText("");
//            socket.emit("send", {"chatroomId": chatroomId, "senderId": senderId});
            //socket.emit("send", chatroomId);
        }
    }
    ...
    private Emitter.Listener onNewMessage = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            String broadcast_chatroomId = (String) args[0];
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d("socket new message from", broadcast_chatroomId);
                    refresh();
                }
            });
    ...
    private final Emitter.Listener onConnectError = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            runOnUiThread(() -> {
                Log.e("socketio", "Error connecting");
            });
        }
    };
